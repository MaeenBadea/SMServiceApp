...
export default class CustomButton extends Component {
  ...
  handlePress = () => {
    ...
    render() {
        const {width , height , title , action  , isLoading ,color, disabled, extras} = this.props;
        return (
          <TouchableHighlight
          style={[styles.btn, {width , height, backgroundColor: color?color:colors.baseblue, ...extras}]}
